...
# Набор данных 'diabetes_012_health_indicators_BRFSS2015.csv' не содержал пропущенных значений, но в нем присутствовало несколько дубликатов, которые были удалены. Значения 2 в таргетном столбце были преобразованы в 1, так как это пребовало услование задания.
# 
